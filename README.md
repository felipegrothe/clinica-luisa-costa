...
- `precificador.html`: tratamentos, precificação, planos, aplicações e rastreabilidade.
...
16. `supabase-tratamentos-rastreabilidade.sql` — planos manuais, aplicações, lotes e histórico
17. `supabase-usuarios-integridade.sql` — sincroniza contas de autenticação com perfis e recupera cadastros invisíveis
